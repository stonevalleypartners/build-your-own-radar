...
const Radar = function (size, radar) {
  ...
  function plotRadarFooter () {
    hostingTerms = process.env.HOSTING_TERMS ||
      ...
      ', which describes how we will gather, use and protect any personal data contained ' +
      'in your public Google Sheet. This software is ' +
      '<a href="https://github.com/thoughtworks/build-your-own-radar">open source</a> ' +
